                            ...
                            <tr>
                                ...
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 text-emerald-500 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className='text-xl font-bold' className="text-sm font-normal">Paid</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <div>
                                            <h2 className='text-xl font-bold' className="text-sm font-medium text-gray-800 dark:text-white ">Arthur Melo</h2>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 text-red-500 rounded-full gap-x-2 bg-red-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className='text-xl font-bold' className="text-sm font-normal">Cancelled</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <div>
                                            <h2 className='text-xl font-bold' className="text-sm font-medium text-gray-800 dark:text-white ">Andi Lane</h2>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <div>
                                            <h2 className='text-xl font-bold' className="text-sm font-medium text-gray-800 dark:text-white ">Kate Morrison</h2>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <div>
                                            <h2 className='text-xl font-bold' className="text-sm font-medium text-gray-800 dark:text-white ">Candice Wu</h2>
                            ...
                            <tr>
                                ...
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 text-gray-500 rounded-full gap-x-2 bg-gray-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className='text-xl font-bold' className="text-sm font-normal">Refunded</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">
                                    <div className="flex items-center gap-x-2">
                                        ...
                                        <div>
                                            <h2 className='text-xl font-bold' className="text-sm font-medium text-gray-800 dark:text-white ">Orlando Diggs</h2>
