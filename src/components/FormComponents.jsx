    ...
    <div className="flex items-center">
      ...
      <div className="relative inline-block w-10 mr-2 align-middle select-none transition duration-200 ease-in">
        <input
          ...
          className={`toggle-checkbox absolute block w-6 h-6 rounded-full transition-all ${checked?'bg-[#1874BD] translate-x-4':'bg-white translate-x-0'} border-4 appearance-none cursor-pointer`}
        />
        <label
          htmlFor={name}
