                    ...
                    <ul className="border border-gray-200 rounded-md divide-y divide-gray-200">
                      {admin?.shop?.socialPlatforms?.length > 0 ? (
                              ...
                              name && (
                                ...
                                >
                                  <div className="w-0 flex-1 flex items-center">
                                    ...
                                    >
                                      <span className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-[#1874BD] hover:bg-blue-600">
                                        <Icon
                                          icon={icon}
                                  ...
                                  <div className="flex-shrink-0 sm:ml-4">
                                    <button
                                      type="button"
                                      className="font-medium text-blue-600 hover:text-[#1874BD]"
                                    >
                                      Edit
                                    </button>
                                  </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <a
                            href=""
                            className=" text-white bg-[#1874BD] rounded-sm p-2 mx-4"
                          >
                            Add now
                          </a>
                        </div>
