...
;  const [showModal, setShowModal] = useState();
  ...
  //create promotion form functions
  ...
  return (
    <div className="productList">
              ...
              <table className="min-w-max w-full table-auto">
                <thead>
                  <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th className="py-3 px-6 text-left">Minimum Purchase Quantity </th>
                        ...
                        return (
                            ...
                            >
                              ...
                              <td className="py-3 px-6 text-left">
                                <div className="flex items-center">
                                  <span className="font-medium">{`${promotion?.discountVolume} ${promotion?.product?.price}`}</span>
                                </div>
                              </td>
      ...
      <ReactModal isOpen={showModal} style={customStyles}>
        <form className="fixed right-0 bottom-0 w-96 h-screen bg-white p-4 transform translate-x-full transition-transform duration-300 ease-in-out">
          <div className="mb-4">
            <label
