  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://api-bekkah.onrender.com/api/seller/account/bank",
        {
          bankAddress,
          bankName,
          accountNumber,
    ...
    <div className="w-screen h-screen">
      ...
      <form onSubmit={handleSubmit} className="bg-white m-auto w-[70%] max-w-[600px] shadow-md rounded px-8 pt-6 pb-8 mb-4">
        ...
        <div className="flex items-center justify-between">
          <button
            disabled={processing}
            className="bg-[#1874BD] hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline"
            type="submit"
          >
            {processing
              ? "Processing"
